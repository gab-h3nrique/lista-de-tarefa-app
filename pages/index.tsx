...
<div className="h-screen bg-gray-500">
	<nav className="flex justify-center p-4 bg-gray-600">
		<h1 className="text-white text-2xl font-bold">App de lista</h1>
	</nav>
	<div>
		<form className="flex justify-center mt-10">
			<div className="bg-gray-50 p-8 rounded-lg">
				<h1 className="text-center mb-4">Escreva sua lista</h1>
				<div className="flex space-x-2 p-2 bg-white rounded-md">
					<input value={description} onChange={(e) => setDescription(e.currentTarget.value)} type="text" placeholder="Anote aqui ...." className="w-full outline-none" />
					<button onClick={() => handleClick()} className="bg-green-500 px-2 py-1 rounded-md text-white font-semibold">salvar</button>
				</div>
			</div>
		</form>
		<div>
